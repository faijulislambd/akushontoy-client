...
const Toys = () => {
  ...
  useEffect(() => {
    const url =
      searchText === ""
        ? `https://akushontoy-server.vercel.app/totalToys`
        : `https://akushontoy-server.vercel.app/totalToys?toy_name=${searchText}`;
    fetch(url)
      .then((res) => res.json())
      .then((data) => {
  ...
  useEffect(() => {
    const url =
      searchText === ""
        ? `https://akushontoy-server.vercel.app/toys?price=${priceSort}`
        : `https://akushontoy-server.vercel.app/toys?toy_name=${searchText}&price=${priceSort}`;
    fetch(url)
      .then((res) => res.json())
      .then((data) => {
        setLoadedToys(data);
  ...
  useEffect(() => {
    const url =
      priceSort === ""
        ? `https://akushontoy-server.vercel.app/toys?toy_name=${searchText}`
        : `https://akushontoy-server.vercel.app/toys?toy_name=${searchText}&price=${priceSort}`;
  ...
  useEffect(() => {
    const url = "https://akushontoy-server.vercel.app/toys";
  ...
  useEffect(() => {
    fetch(
      `https://akushontoy-server.vercel.app/toys?page=${currentPage}&$limit=${toysPerPage}`
    )
      .then((res) => res.json())
